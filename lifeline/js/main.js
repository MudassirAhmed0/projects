/** ==========================================================================================
  ...
  Project :   Lifeline Biosciences - Responsive Multi-purpose HTML5 Template
...
(function ($) {
    ...
    $(function () {
        ...
        $('.contact-btn > a').on('click', function (event) {
            event.preventDefault();
...
contactBtn.addEventListener("click", popupHandler)
popupClose.addEventListener("click", popupHandler)

document.querySelectorAll('.contactKBtn').forEach(btn=>btn.addEventListener('click',popupHandler))